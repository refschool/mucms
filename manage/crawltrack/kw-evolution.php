...
<div id="tabs">
	...
	<div id="tabs-1">
		...
		?>
			<form action="<?=$_SERVER['PHP_SELF'];?>?id_page=<?=$_GET['id_page']?>&id_keyword=<?=$_GET['id_keyword']?>" method="post" >
					<table>
					<tr>
						<td>
...
$kw_count = get_keyword_evolution($_GET['id_keyword'],$_GET['id_page'],$_POST['start'],$_POST['end']);

echo '<table class="collapse"><tr><th>Keyword</th><th>Hits</th><th>Date</th><th>Page</th></tr>';
...
<tr>
	...
	<td><?=$kw_count[$i]['month']. ' ' .$kw_count[$i]['year']?></td>
	<td><?=$tld2.$kw_count[$i]['url_page']?></td>
</tr>
