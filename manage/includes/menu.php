<ul>
<li><a href="<?=$tld2?>">View Site</a></li>
<li><a href="<?=$tld2?>/manage/write.php">Edition</a></li>
<li><a href="<?=$tld2?>/manage/newpost.php">Add Post</a></li>
<li><a href="<?=$tld2?>/manage/seo/seo.php">SEO</a>
	<ul>
		<li><a href="<?=$tld2?>/manage/seo/seo.php">SEO</a></li>
